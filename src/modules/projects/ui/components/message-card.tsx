...
const FragmentCard=({fragment,isActiveFragment,onFragmentClick}:FragmentCardProps)=>{
    return <button
        className={cn("flex p-3 items-start text-start gap-2 border" +
            " rounded-lg" +
            " bg-muted w-fit hover:bg-secondary transition-colors",isActiveFragment&&"" +
...
const AssistantMessage=({
    content,fragment,createdAt,isActiveFragment,onFragmentClick,type,}:AssistantMessageProps)=>{
    return (
